 ...
 */
export declare function wrapForMultiplexer(osc52: string, env: NodeJS.ProcessEnv): string;
 ...
 */
export declare function buildOsc52(text: string, capBytes?: number): Osc52Sequence;
