 ...
 * @module
 */
import { CHART_WIDTH, filledWidth, grouped, sortedRows, totalUsage, } from "../usage.js";
import { displayWidth, padEnd, truncate } from "./text.js";
import { bold, colAccent, colGold, colGreen, colOK, colRose, colWarn, muted, ok, style, warn, } from "./theme.js";
...
export class UsageView {
    ...
    setData(session, week, lifetime, deepSeekPeak, now) {
...
export function renderUsagePane(view, width) {
    const hasAny = Object.keys(view.lifetime).length > 0 ||
    ...
    if (view.deepSeekPeak !== undefined) {
        ...
        out.push(view.deepSeekPeak.peak
