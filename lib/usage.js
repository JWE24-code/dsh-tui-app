 ...
 */
import { displayWidth, padEnd } from "./tui/text.js";
...
function sortedRows(ledger) {
    return Object.entries(ledger).sort(([, a], [, b]) => b.promptTokens + b.completionTokens - (a.promptTokens + a.completionTokens));
}
 ...
 */
export function renderUsageChart(ledger) {
